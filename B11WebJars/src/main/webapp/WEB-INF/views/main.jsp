...
<body>
	...
	<ul>
		...
		<li><a href="/jsonQuiz.do">복잡한 json 만들기</a></li>
	</ul>
	...
	//jQuery의 엔트리 포인트
	$(function(){
		//HTML 문서의 로드가 완료된 후 이 부분이 실행된다.
		//alert('jQuery 로드 완료');

		/* 특정 엘리먼트에 접근할때 CSS의 선택자를 사용하면 된다.
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Modal 타이틀</h4>
