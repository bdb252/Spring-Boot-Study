...
/*
@ResponseBody + @Controller 와 같은 형태로 RestAPI를 만들기 위한 컨트롤러에서
사용된다. 내부 메서드에서 반환하는 값은 웹브라우저에 출력된다. 
(일반적인 컨트롤러에서의 반환값은 View의 경로가 된다.) */
@RestController
public class MyRestController {
	/*
	JSON객체 : Map 은 Key와 Value를 가진 구조이므로 JSON 객체와 동일하다.
	...
	경우에 따라 객체 내부에 또다른 객체를 포함할 수도 있다. */
	...
	*/
	...
	public List<PersonVO> restApi04(){
		...
		PersonVO vo3 = new PersonVO("송태섭", 22, "파워포가드");
